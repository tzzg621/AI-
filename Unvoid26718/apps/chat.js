...
<div style="font-size:11px; color:#888; margin-top:4px; text-align:center;">点击更换头像</div>
            ...
            <div class="profile-stats" style="margin-top:12px;">
                ${Object.entries(chara.base.stats || {}).map(([key, val]) => `
                    <div class="stat-item" style="display:flex; justify-content:space-between; padding:8px 0; border-bottom:1px solid #eee;">
                        <div class="stat-label" style="font-weight:500;">${key}</div>
                        <div class="stat-value" style="font-weight:600; color:#e91e63;">${val}</div>
                    </div>
                `).join('')}
            </div>
