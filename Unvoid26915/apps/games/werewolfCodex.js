...
export const ENTRIES = [
    ...
    {
        id: 'std12_hunter', scope: ['standard12', 'sheriff12'], tier: 'basic', cond: 'always',
        title: '猎人不是什么时候都能开枪',
    ...
    {
        id: 'sheriff12_idiot', scope: 'sheriff12', tier: 'basic', cond: 'always',
        title: '白痴翻牌不算出局',
        text: '白痴被投票出局时翻开底牌，当场免死——他不算出局，人还在、还能说话，只是此后没有投票权、也不会再被投票放逐、警徽也接不到他手里；但他夜里照样会被狼刀死。'
    },
    {
        id: 'common_idiot', scope: 'common', tier: 'principle', cond: 'role:idiot:1',
        title: '拿到白痴别怕被投',
