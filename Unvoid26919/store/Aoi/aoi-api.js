    ...
    const html = `
        <div style="border-top:1px solid #f0f0f0; margin:0 16px;">
            ...
            <div id="aoiApiBody" style="display:none; padding:0 0 12px;">
                ...
                <input type="text" id="aoiEndpoint" value="${esc(config.endpoint)}" placeholder="https://api.deepseek.com/v1"
                ...
                <div style="display:flex;gap:4px;margin-bottom:8px;">
                    ...
                    ">
                        <option value="${esc(config.model)}" selected>${esc(config.model) || '请拉取或输入'}</option>
                    </select>
